...
### Add environmental variables unto Lambda code instead of hardcoding configurations

* Secrets hardcoded into the source-code can be used maliciously if compromised by an attacker.
* Using Environmental Variables like API Keys and Account numbers are stored securely while using variables
